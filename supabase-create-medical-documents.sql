-- Crear tabla medical_documents para documentos y estudios médicos
...
CREATE INDEX IF NOT EXISTS idx_medical_documents_uploaded_at ON medical_documents(uploaded_at DESC);
